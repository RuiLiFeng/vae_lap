...
import numpy as np
import network.vae_celeba as nn
...
parser.add_argument(
    '--dataset_name', type=str, default='celeb_a',
...
parser.add_argument(
    ...
    help='Which Dataset to train on, out of I128, I256, C10, C100; (default: %(default)s)')
parser.add_argument(
    '--dim_z', type=int, default=64,
    help='Which Dataset to train on, out of I128, I256, C10, C100; (default: %(default)s)')
parser.add_argument(
    '--restore_e_dir', type=str, default='mnist',
    help='Which Dataset to train on, out of I128, I256, C10, C100; (default: %(default)s)')
parser.add_argument(
    '--model_dir_root', type=str, default='/gdata/visual/',
    help='Which Dataset to train on, out of I128, I256, C10, C100; (default: %(default)s)')
parser.add_argument(
    '--model_dir', type=str, default='test',
    help='Which Dataset to train on, out of I128, I256, C10, C100; (default: %(default)s)')
